package com.dietmanager.restaurant.helper.stickyadapter;
...
public class StickyHeaderLayoutManager extends RecyclerView.LayoutManager {
    ...
    /**
     * @param fullyVisibleOnly if true, the search will be limited to the first header not hanging off
     *                         top of screen
    ...
    /**
     * @param fullyVisibleOnly if true, the search will be limited to the first footer not hanging off
     *                         top of screen or partially obscured by a header
    ...
    /**
     * @param fullyVisibleOnly if true, the search will be limited to the last item not hanging off
     *                         bottom of screen
    ...
    public SectioningAdapter.ItemViewHolder getLastVisibleItemViewHolder(boolean fullyVisibleOnly) {
        return (SectioningAdapter.ItemViewHolder) getLastVisibleViewHolderOfType(
                SectioningAdapter.TYPE_ITEM, fullyVisibleOnly);
    }

    /**
     * @param fullyVisibleOnly if true, the search will be limited to the last header not hanging off
     *                         bottom of screen
     * @return the viewholder for the last visible header (not item or footer)
     */
    @Nullable
    public SectioningAdapter.HeaderViewHolder getLastVisibleHeaderViewHolder(
            boolean fullyVisibleOnly) {
        return (SectioningAdapter.HeaderViewHolder) getLastVisibleViewHolderOfType(
                SectioningAdapter.TYPE_HEADER, fullyVisibleOnly);
    }

    /**
     * @param fullyVisibleOnly if true, the search will be limited to the last footer not hanging off
     *                         bottom of screen
     * @return the viewholder for the last visible footer (not header or item)
     */
    @Nullable
    public SectioningAdapter.FooterViewHolder getLastVisibleFooterViewHolder(
            boolean fullyVisibleOnly) {
        return (SectioningAdapter.FooterViewHolder) getLastVisibleViewHolderOfType(
                SectioningAdapter.TYPE_FOOTER, fullyVisibleOnly);
    }

    @Nullable
    private SectioningAdapter.ViewHolder getLastVisibleViewHolderOfType(int baseType,
                                                                        boolean fullyVisibleOnly) {
        if (getChildCount() == 0) {
            return null;
        }
