...
public class SubscribedPlanAdapter extends RecyclerView.Adapter<SubscribedPlanAdapter.MyViewHolder> {
    ...
    private List<SubscribedPlans> list;

    public SubscribedPlanAdapter(List<SubscribedPlans> list, Context con) {
        this.list = list;
        this.context = con;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        SubscribedPlans order = list.get(position);
    ...
    public void setList(List<SubscribedPlans> list) {
        this.list = list;
    }
